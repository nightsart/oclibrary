const characters = [
    ...
    { imageURL: "images/dawn.webp",      name: "Dawn",       categories: ["NonH", "Female", "Night", "LSA"],             fullName: "❝Timeless Embrace❞", species: "Angel of Crystal (arctic fox hybrid)" },
    ...
    { imageURL: "images/evan.webp",      name: "Evan",       categories: ["NonH", "Male", "Night", "LSA"],             	 species: "Angel of the Abyss (human)" },
    ...
    { imageURL: "images/kiara.webp",     name: "Kiara",      categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Kiara</br>❝The Ruthless❞", species: "Vesperis, horror", pronunciation: "kee-AR-uh", quote: "Oh, shut your hole! You worthless, pathetic, whining little rat. Is this how you intended to protect your family? I must be doing them a favor." },
    ...
    { imageURL: "images/mist.webp",      name: "Mist",       categories: ["NonH", "Male", "Night", "LSH"],               fullName: "Mist Wraith (Kade Robertson)", species: "Cursed", ability:"Illusions", quote: "To the moon and back." },
