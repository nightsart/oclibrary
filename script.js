const characters = [
    ...
    { imageURL: "images/cherry.webp",    name: "Cherry",     categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Cherry Rose</br>❝Frosted Flame❞", species: "Dream Eater", ability:"Soporific flames", quote: "So hungry..." },
    { imageURL: "images/daphne.webp",    name: "Daphne",     categories: ["Human", "Female", "Night", "LSH"],            fullName: "Daphne †", quote: "Miss, you called?" },
    { imageURL: "images/dawn.webp",      name: "Dawn",       categories: ["NonH", "Female", "Night", "LSA"],             fullName: "❝Timeless Embrace❞", species: "Arctic fox hybrid" },
    { imageURL: "images/dj.webp",        name: "DJ",         categories: ["Human", "Male", "Dj", "Gang"],                 },
    { imageURL: "images/dolly.webp",     name: "Dolly",      categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Draya Sirah</br>❝Porcelain Phantom❞", species: "Hybrid", quote: "I don't remember you." },
    ...
    { imageURL: "images/evan.webp",      name: "Evan",       categories: ["NonH", "Male", "Night", "LSA"],             	 species: "Human" },
    ...
    { imageURL: "images/iris.webp",      name: "Iris",       categories: ["Human", "Female", "Night", "envision"],       fullName: "CC734 (Kris Kaelin)", rune:"Tentacles - Thermal eye - Incorporeal", quote: "Hun... You’re going to make this way more complicated than it needs to be, aren’t you?", runeURL:"images/iris_rune.webp", },
    { imageURL: "images/jade.webp",      name: "Jade",       categories: ["Human", "Female", "Night", "Others", "Pin"],         fullName: "Jade Quinn", rune:"Crystalline resonance", quote: "Sure, how can I help?" },
    { imageURL: "images/kaelani.webp",   name: "Kae",        categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Kaelani</br>❝Bibliophile❞", pronunciation: "kay- or ka-eh-LAH-nee", species: "Vuuna", ability:"Abyss", quote: "But satisfaction brought it back, remember? If you're going to use idioms, use the whole quote.", },
    ...
    { imageURL: "images/kiara.webp",     name: "Kiara",      categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Kiara</br>❝The Ruthless❞", species: "Bat hybrid, horror", pronunciation: "kee-AR-uh", quote: "Oh, shut your hole! You worthless, pathetic, whining little rat. Is this how you intended to protect your family? I must be doing them a favor." },
    ...
    { imageURL: "images/lisy.webp",      name: "Lisy",       categories: ["Human", "Female", "Night", "Cops"],           fullName: "Atari Moon", rune:"Blood roses", quote: "Have you lost weight? Oh, nevermind. That dress makes you look nice.", runeURL:"images/lisy_rune.webp", },
    ...
    { imageURL: "images/lyra.webp",      name: "Lyra",       categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Lyra Circe</br>❝Graceful Sun❞", species: "Hybrid", pronunciation: "LIE-rah SIR-see", quote: "Don't think about it, dance with your heart! Nobody's watching." },
    { imageURL: "images/melissa.webp",   name: "Melissa",    categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Melissa Circe</br>❝Swift Death❞", species: "Hybrid", quote: "Running won't save you." },
    { imageURL: "images/mei.webp",       name: "Mei",        categories: ["Human", "Female", "Night", "Others"],         fullName: "Nakamura Mei", rune:"None" },
    { imageURL: "images/mika.webp",      name: "Mika",       categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Mika Quartz</br>❝Rose Quartz❞", species: "Crysta'lynn", quote: "I miss my family but I'm glad I'm here with you right now. I think I made the right choice." },
    ...
    { imageURL: "images/naiya.webp",     name: "Naiya",      categories: ["Human", "Female", "Night", "Gang"],           fullName: "Naiya Sirah", pronunciation: "NA-yah SIGH-rah", rune:"Magnets", quote: "Hmm?" },
    ...
    { imageURL: "images/nyx.webp",       name: "Nyx",        categories: ["NonH", "Female", "Night", "Gang"],            fullName: "Nyx Anthis", species: "Fox hybrid", rune:"Light bending - Size manipulation", quote: "How dare you oppose me, your beautiful, humble Goddess?", runeURL:"images/nyx_rune.webp", },
    ...
    { imageURL: "images/skye.webp",      name: "Skye",       categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Skye Lua</br>❝Gleaming Light❞ (Butterfly)", species: "Horror hybrid", ability:"Celestial Protection", quote: "You need not speak your pain for I can read it in your eyes." },
