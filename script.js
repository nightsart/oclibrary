const characters = [
    { imageURL: "images/aaron.png",     name: "Aaron",      categories: ["Human", "Male", "Night", "Gang"],             rune:"One with the shadows" },
    { imageURL: "images/alyssa.png",    name: "Alyssa",     categories: ["Human", "Female", "Dj", "Others"],            rune:"None" },
    { imageURL: "images/amy.png",       name: "Amy",        categories: ["Human", "Female", "Night", "Gang"],           fullName: "Kawa Amy (Ishikawa Kira)", rune:"Nightmare", quote: "Don't get all shy, now~ Tonight has only just begun!" },
    { imageURL: "images/anko.png",      name: "Anko",       categories: ["Human", "Female", "Night", "Others"],         fullName: "Kamei Anko", rune:"None", },
    { imageURL: "images/ash.png",       name: "Arsonist",   categories: ["Human", "Male", "Dj", "Others"],              fullName: "Ashton 'Ash' Grey" },
    { imageURL: "images/ayumi.png",     name: "Ayumi",      categories: ["Human", "Female", "Night", "Others"],         fullName: "Arai Ayumi †", rune:"Organic sight" },
    { imageURL: "images/azure.png",     name: "Azure",      categories: ["Human", "Female", "Night", "Gang", "Others"], fullName: "Azure Lozanov", rune:"Thread creation" },
    { imageURL: "images/gabriel.png",   name: "Birdeye",    categories: ["Human", "Male", "Dj", "Others"],              fullName: "Gabriel Osmin", rune:"None" },
    { imageURL: "images/boss.png",      name: "Boss",       categories: ["Human", "Male", "Dj", "Gang"],                 },
    { imageURL: "images/cara.png",      name: "Cara",       categories: ["Human", "Female", "Night", "Gang"],           fullName: "Omura Cara", pronunciation: "KA-ruh", rune:"Metamorphosis", quote: "Leave me alone." },
    { imageURL: "images/cassie.png",    name: "Cassie",     categories: ["Human", "Female", "Night", "Gang"],           fullName: "Cassandra O'Connor", rune:"Tricks & Mirrors" },
    ...
    { imageURL: "images/ember.png",     name: "Ember",      categories: ["Human", "Female", "Night", "Cops", "Others"], fullName: "Ember Evans", rune:"Knot", quote: "Hey, wha- Stop, I said I don't like pictures..." },
    { imageURL: "images/fc25.png",      name: "FC25",       categories: ["Human", "Female", "Night", "Gang", "Others"], fullName: "FC25/FC or Ci</br>(Fabularis Ciuem Series 2 Type 5)", pronunciation: "'Ci': KEY", rune:"Tracking", quote: "Why are you so delicious?" },
    { imageURL: "images/fukure.png",    name: "Fukure",     categories: ["Human", "Male", "Dj", "Cops"],                fullName: "Fukure Isayac", rune:"Memory manipulation" },
    { imageURL: "images/gwen.png",      name: "Gwen",       categories: ["Human", "Female", "Night", "Gang"],           fullName: "Gwendolyn Heartstill", rune:"Toxic empathy", quote: "Huh? What does that mean? Stop using big words with me!" },
    { imageURL: "images/iris.png",      name: "Iris",       categories: ["Human", "Female", "Night", "envision"],       fullName: "CC734 (Kris Kaelin)", rune:"Tentacles - Thermal eye - Incorporeal", quote: "Hun... You’re going to make this way more complicated than it needs to be, aren’t you?" },
    { imageURL: "images/jade.png",      name: "Jade",       categories: ["Human", "Female", "Night", "Others"],         fullName: "Jade Quinn", rune:"Crystalline resonance", quote: "Sure, how can I help?" },
    { imageURL: "images/kaelani.png",   name: "Kae",        categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Kaelani </br> ❝Bibliophile❞", pronunciation: "kay- or ka-eh-LAH-nee", species: "Vuuna", ability:"Innate dark mage", quote: "But satisfaction brought it back, remember? If you're going to use idioms, use the whole quote." },
    ...
    { imageURL: "images/lisy.png",      name: "Lisy",       categories: ["Human", "Female", "Night", "Cops"],           fullName: "Atari Moon", rune:"Blood roses", quote: "Have you lost weight? Oh, nevermind. That dress makes you look nice." },
    { imageURL: "images/liza.png",      name: "Liza",       categories: ["Human", "Female", "Dj", "envision"],          fullName: "Liza Goff", rune:"Rhythm sync" },
    ...
    { imageURL: "images/mei.png",       name: "Mei",        categories: ["Human", "Female", "Night", "Others"],         fullName: "Nakamura Mei", rune:"None" },
    ...
    { imageURL: "images/moon.png",      name: "Moon",       categories: ["Human", "Female", "Night", "Cops"],           fullName: "Atari Moon", species: "Human, hybrid via shapeshifting", rune:"Partial shapeshifting (small mammals only)", quote: "Do they sell donuts?" },
    { imageURL: "images/naiya.png",     name: "Naiya",      categories: ["Human", "Female", "Night", "Gang"],           fullName: "Naiya Sirah", pronunciation: "NA-yah SIGH-rah", rune:"Iron telekinesis", quote: "Hmm?" },
    ...
    { imageURL: "images/nyx.png",       name: "Nyx",        categories: ["NonH", "Female", "Night", "Gang"],            fullName: "Nyx Anthis", species: "Fox hybrid", rune:"Light bending", quote: "How dare you oppose me, your beautiful, humble Goddess?" },
