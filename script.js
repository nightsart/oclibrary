const characters = [
    ...
    { imageURL: "images/alyssa.png",    name: "Alyssa",     categories: ["Human", "Female", "Dj", "Others", "Pin"] },
    ...
    { imageURL: "images/ayumi.png",     name: "Ayumi",      categories: ["Human", "Female", "Night", "Others", "Pin"],         fullName: "Arai Ayumi" },
    ...
    { imageURL: "images/ela.png",       name: "Ela",        categories: ["Human", "Female", "Dj", "Cops", "Pin"],              fullName: "Elizabeth Grande" },
    ...
    { imageURL: "images/liza.png",      name: "Liza",       categories: ["Human", "Female", "Dj", "envision", "Pin"],          fullName: "Liza Goff" },
    { imageURL: "images/luna.png",      name: "Luna",       categories: ["Human", "Female", "Night", "Others"],         fullName: "Luna Selene", quote: "Meow?" },
    ...
    { imageURL: "images/melissa.jpg",   name: "Melissa",    categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Melissa Circe </br> ❝Swift Death❞", species: "Velis", quote: "Running won't save you." },
    { imageURL: "images/mika.jpg",      name: "Mika",       categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Mika Quartz </br> ❝Rose Quartz❞", species: "Crysta'lynn", quote: "I  think about my family daily. Regardless, I'm glad I'm here with you right now. I think I made the right choice." },
    ...
    { imageURL: "images/moon.png",      name: "Moon",       categories: ["Human", "Female", "Night", "Cops"],           fullName: "Atari Moon", species: "bnnuy", quote: "Do they sell donuts?" },
    ...
    { imageURL: "images/scarlet.png",   name: "Scarlet",    categories: ["Human", "Female", "Dj", "Cops", "Pin"] },
    { imageURL: "images/shie.png",      name: "Shie",       categories: ["Human", "Female", "Night", "Cops"],           fullName: "Kaeshi Shie", pronunciation: "SHE-eh" },
    { imageURL: "images/skye.jpg",      name: "Skye",       categories: ["NonH", "Female", "Night", "LSE"],             fullName: "Skye Lua </br> ❝Gleaming Light❞ (Butterfly)", species: "Horror hybrid", quote: "You need not speak your pain for I can read it in your eyes." },
