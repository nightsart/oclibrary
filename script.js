const characters = [
    { imageURL: "images/aaron.png",     name: "Aaron",      categories: ["Human", "Male", "Night", "Gang", "Pin"],              rune:"One with the shadows" },
    ...
    { imageURL: "images/azure.png",     name: "Azure",      categories: ["Human", "Female", "Night", "Gang", "Others", "Pin"],  fullName: "Azure Lozanov", rune:"Thread creation" },
    ...
    { imageURL: "images/ember.webp",     name: "Ember",      categories: ["Human", "Female", "Night", "Cops", "Others"], fullName: "Ember Evans", rune:"Knot", quote: "Hey, wha- Stop, I said I don't like pictures..." },
    { imageURL: "images/fc25.webp",      name: "FC25",       categories: ["Human", "Female", "Night", "Gang", "Others"], fullName: "FC25/FC or Ci</br>(Fabularis Ciuem Series 2 Type 5)", pronunciation: "'Ci': KEY", rune:"Tracking", quote: "Why are you so delicious?" },
    { imageURL: "images/fukure.webp",    name: "Fukure",     categories: ["Human", "Male", "Dj", "Cops"],                fullName: "Fukure Isayac", rune:"Memory manipulation" },
    { imageURL: "images/gwen.webp",      name: "Gwen",       categories: ["Human", "Female", "Night", "Gang"],           fullName: "Gwendolyn Heartstill", rune:"Toxic empathy", quote: "Huh? What does that mean? Stop using big words with me!" },
    ...
    { imageURL: "images/kenzie.png",    name: "Kenzie",     categories: ["Human", "Female", "Night", "Others", "Pin"],         fullName: "Kenzie 'Zee' Sallie", rune:"Rewrite" },
    ...
    { imageURL: "images/kyra.png",      name: "Kyra",       categories: ["Human", "Female", "Night", "Gang", "Others", "Pin"], fullName: "Kawa Kyra (Ishikawa Ami)", rune:"Sweet dreams" },
    ...
    { imageURL: "images/nyx.webp",       name: "Nyx",        categories: ["NonH", "Female", "Night", "Gang"],            fullName: "Nyx Anthis", species: "Fox hybrid", rune:"Light bending", quote: "How dare you oppose me, your beautiful, humble Goddess?" },
    ...
    { imageURL: "images/shie.png",      name: "Shie",       categories: ["Human", "Female", "Night", "Cops", "Pin"],           fullName: "Kaeshi Shie", pronunciation: "SHE-eh", rune:"Freeze" },
    ...
    { imageURL: "images/tyler.png",     name: "Tyler",      categories: ["Human", "Male", "Night", "Others", "Pin"],           rune:"None", quote: "Gwen..." },
